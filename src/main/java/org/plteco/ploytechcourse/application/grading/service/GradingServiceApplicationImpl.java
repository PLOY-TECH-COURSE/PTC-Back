...
public class GradingServiceApplicationImpl implements GradingServiceApplication {
    ...
    public void addScore(Long formId, RequestScoreDto scoreDto) {
        ...
        // 4. 중복 평가 방지 - 이미 해당 평가자가 이 학생을 평가했는지 확인
        ...
        // 5. 각 답변에 대해 GradingAnswer 엔티티 생성 및 저장
        ...
        System.out.println(totalExpectedAnswers);
        System.out.println(currentAnswerCount);
        System.out.println(gradingForm.isCompleted());
        System.out.println((currentAnswerCount >= totalExpectedAnswers));
